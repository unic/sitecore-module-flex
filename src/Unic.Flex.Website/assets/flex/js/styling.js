 ...
 * @requires ../../assets/vendor/jquery.uniform/jquery.uniform.js
 */
	...
	var pluginName = 'flexstyles',
		...
		defaults = {
			...
			uniformOptions: {
				...
				autoHide: true,
				buttonClass: 'flex_button',
				checkboxClass: 'flex_checker',
				checkedClass: 'flex_checked',
				disabledClass: 'flex_disabled',
				eventNamespace: '.flex_uniform',
				fileButtonClass: 'flex_action',
				fileButtonHtml: 'Choose File',
				fileClass: 'flex_uploader',
				fileDefaultHtml: 'No file selected',
				filenameClass: 'flex_filename',
				focusClass: 'flex_focus',
				hoverClass: 'flex_hover',
				idPrefix: 'flex_uniform',
				inputAddTypeAsClass: true,
				inputClass: 'flex_uniform-input',
