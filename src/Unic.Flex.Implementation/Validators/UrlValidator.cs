namespace Unic.Flex.Implementation.Validators
{
    ...
    /// <summary>
    /// Validates the format of an url.
    /// </summary>
    [SitecoreType(TemplateId = "{16F14E15-2392-4E4E-A12D-0FF7455E4C72}")]
    public class UrlValidator : RegularExpressionValidator
    {
        ...
        /// </value>
        [SitecoreDictionaryFallbackField("Validation Message", "Url is invalid")]
