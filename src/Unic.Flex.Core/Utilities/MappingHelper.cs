namespace Unic.Flex.Core.Utilities
{
    ...
    public static class MappingHelper
    {
        ...
        /// <summary>
        /// Gets the prefix of the id of a html input field.
        /// </summary>
        /// <param name="sectionIndex">Index of the section.</param>
        /// <param name="fieldIndex">Index of the field.</param>
        /// <returns>Id string</returns>
        public static string GetFormFieldIdPrefix(int sectionIndex, int fieldIndex)
        {
            return string.Format("ActiveStep.Sections[{0}].Fields[{1}]", sectionIndex, fieldIndex);
        }
        ...
        {
            return string.Format("{0}.Value", GetFormFieldIdPrefix(sectionIndex, fieldIndex));
        }
